<?php
//include("session_verification1.php");
?>
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    <li class="TabbedPanelsTab" tabindex="0">Sale Product</li>
  ...
  <div class="TabbedPanelsContentGroup">
    <div class="TabbedPanelsContent">
      <div id="TabbedPanels2" class="TabbedPanels">
        ...
        <div class="TabbedPanelsContentGroup">
          <div class="TabbedPanelsContent">
          <iframe src=ItemsShow.php?Username=$Username width="950px" height="800px" align="center"></iframe>
          </div>
          <div class="TabbedPanelsContent">
