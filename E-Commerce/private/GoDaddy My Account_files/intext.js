...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '30.0',
  browsersupport: '1',
  appsig: 'S20141394986928z',
  subscribe: '',
  subscribe2: '',
  branduid: 'e5caf58448f4445fa0aa2567ce66d721|1394986928',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://dresscode.amaderkotha.com/',
  page_url: '?',
  refer_domain: 'dresscode.amaderkotha.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '203.223.94.188'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 203.223.94.188 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://dresscode.amaderkotha.com/'; */
    properties.page_domain=''; /* 'dresscode.amaderkotha.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('l05q3vx09mpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function doMouseClickl05q3vx09m()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg l05q3vx09m_3, l05q3vx09m_4, ... l05q3vx09m_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'l05q3vx09m';
     span.id = 'l05q3vx09m' + "_" + properties.spancount;
     span.name='l05q3vx09m' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'l05q3vx09mspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickl05q3vx09m,   false);
  addEvent(adpop_span, "click", doMouseClickl05q3vx09m);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'l05q3vx09mframe';
  gframe.name = 'l05q3vx09mframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('l05q3vx09mframe');
 ...
 function setupl05q3vx09mCSS()
 {
  writeLog(1, 'setupl05q3vx09mCSS()');
  ...
  // style.innerHTML = '.l05q3vx09m { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.l05q3vx09m { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.l05q3vx09m {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.l05q3vx09m {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.l05q3vx09m {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
